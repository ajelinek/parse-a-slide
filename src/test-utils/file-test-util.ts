 ...
 * @returns The absolute path to the test directory
 */
export async function fileSystemSetup(moduleName: string, structure?: FileSystemStructure): Promise<string> {
 ...
 */
export async function exists(moduleName: string, relativePath: string): Promise<boolean> {
 ...
 */
export async function readFile(moduleName: string, relativePath: string): Promise<string> {
  const fullPath = getPath(moduleName, relativePath)
 ...
 */
export function getPath(moduleName: string, relativePath: string): string {
  const testDir = getTestDir(moduleName)
 ...
 */
async function processStructure(testDir: string, structure: FileSystemStructure, prefix: string): Promise<void> {
